...
export function SettingsPage() {
  ...
  return (
    <Page title={t('settings.title')}>
      ...
      <section className={styles.card}>
        <h2 className={styles.sectionTitle}>{t('settings.sectionAudio')}</h2>
      ...
      <section className={styles.card}>
        <h2 className={styles.sectionTitle}>{t('settings.sectionMic')}</h2>
      ...
      <section className={styles.card}>
        <h2 className={styles.sectionTitle}>{t('settings.sectionAccess')}</h2>
        <label className={styles.check}>
          <input
            type="checkbox"
