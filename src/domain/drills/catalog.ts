...
const DRILL_LIST: readonly Drill[] = [
  ...
  {
    id: drillId('pistol-10-precision'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.p10p.title',
    briefKey: 'drill.p10p.brief',
  },
  {
    id: drillId('pistol-10-standard'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 10,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.p10s.title',
    briefKey: 'drill.p10s.brief',
  },
  {
    id: drillId('pistol-10-rapid'),
    category: 'issf',
    timerProfile: 'issfExposureSequence',
    expectedShots: 5,
    exposures: { count: 5, windowSec: 3, pauseSec: 1 },
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.p10r.title',
    briefKey: 'drill.p10r.brief',
  },
  {
    id: drillId('center-fire-25'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.cf.title',
    briefKey: 'drill.cf.brief',
  },
  {
  ...
  },
  {
    ...
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.r10.title',
    briefKey: 'drill.r10.brief',
  },
  {
    id: drillId('rifle-50-prone'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.r50p.title',
    briefKey: 'drill.r50p.brief',
  },
  {
    id: drillId('rifle-50-3p'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.r50x.title',
    briefKey: 'drill.r50x.brief',
  },
  {
    id: drillId('rifle-300'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.r300.title',
    briefKey: 'drill.r300.brief',
  },
  {
    id: drillId('service-rifle'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.tar.title',
    briefKey: 'drill.tar.brief',
  },
  {
    id: drillId('speed-sport'),
    category: 'issf',
    timerProfile: 'issfParCountdown',
    expectedShots: 5,
    parSeconds: 300,
    recommendedInput: ['live', 'dryPar', 'dryTap'],
    titleKey: 'drill.tsvSpeed.title',
    briefKey: 'drill.tsvSpeed.brief',
  },
];
